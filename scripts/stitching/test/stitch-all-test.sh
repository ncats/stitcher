...
sbt stitcher/"runMain ncats.stitcher.impl.RanchoJsonEntityFactory $db \"name=FRDB, February 2021\" cache=data/hash.db ../stitcher-rawinputs/files/frdb_2021-02-25.json"
