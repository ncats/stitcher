...
sbt stitcher/"runMain ncats.stitcher.impl.RanchoJsonEntityFactory $db \"name=FRDB, April 2021\" cache=data/hash.db ../stitcher-rawinputs/files/frdb_2021-04-09.json"
