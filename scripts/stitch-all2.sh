...
echo 'gsrs:' $(( ($(date +%s) - $curr_time )/60 )) >> log.txt
...
echo 'rancho:' $(( ($(date +%s) - $curr_time )/60 )) >> log.txt
...
echo 'NPC:' $(( ($(date +%s) - $curr_time )/60 )) >> log.txt
...
echo 'PharmManuEncycl:' $(( ($(date +%s) - $curr_time )/60 )) >> log.txt
...
echo 'DrugBank:' $(( ($(date +%s) - $curr_time )/60 )) >> log.txt
