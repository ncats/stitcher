...
#sbt stitcher/"runMain ncats.stitcher.impl.SRSJsonEntityFactory $db \"name=G-SRS, December 2022\" cache=data/hash.db $stitcherDataInxightRepo/files/dump-public-2021-05-02.gsrs"
