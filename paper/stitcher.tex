...
Stitch key is a core concept in \st. It defines how entities are matched, which, in turn, determines how cliques and connected components are formed. By virtue of its importance, stitch key should reflect the true identity of the entity as much as posible.
