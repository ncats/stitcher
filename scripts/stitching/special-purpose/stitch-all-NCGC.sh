...
sbt stitcher/"runMain ncats.stitcher.impl.SRSJsonEntityFactory $db \"name=G-SRS, July 2023\" cache=data/hash.db $stitcherDataInxightRepo/files/dump-public-2021-05-02.gsrs"
