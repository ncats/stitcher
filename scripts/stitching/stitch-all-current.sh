...
sbt stitcher/"runMain ncats.stitcher.impl.SRSJsonEntityFactory $db \"name=G-SRS, April 2019\" cache=data/hash.db data/dump-public-2019-04-03.gsrs"
echo 'gsrs:' $(( ($(date +%s) - $curr_time )/60 )) 'min' >> $log

sbt stitcher/"runMain ncats.stitcher.impl.RanchoJsonEntityFactory $db \"name=Rancho BioSciences, March 2019\" cache=data/hash.db data/rancho-export_2019-03-06_05-29.json"
...
sbt stitcher/"runMain ncats.stitcher.impl.DrugBankXmlEntityFactory $db \"name=DrugBank, December 2018\" cache=data/hash.db ../inxight-planning/files/drugbank_all_full_database.xml.zip"
